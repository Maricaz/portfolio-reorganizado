import { t as CircleAlert } from "./circle-alert-D2r6PSJl.js";
import { t as ShieldAlert } from "./shield-alert-BDLGbYHH.js";
import { At as useNavigate, Et as Link, It as __toESM, Nt as require_react, Tt as useToast, X as LoaderCircle, Y as Mail, at as createLucideIcon, k as supabase, v as Button, w as useAuth, xt as require_jsx_runtime } from "./index-ukTPz2Gl.js";
import { a as CardHeader, n as CardContent, o as CardTitle, r as CardDescription, t as Card } from "./card-B5VAd9L_.js";
import { n as Input, t as Label } from "./label-Bi3v1ug3.js";
import { n as AlertDescription, r as AlertTitle, t as Alert } from "./alert-Dn--0ZZA.js";
	...
	const handleLogin = async (e) => {
		...
		try {
			...
			if (profile) profileData = profile;
				...
				if (!insertError) {
					const { data: retryProfile } = await supabase.from("profiles").select("role, is_banned").eq("id", data.user.id).single();
					profileData = retryProfile;
				} else console.error("Failed to create profile on login:", insertError);
			}
			if (!profileData) {
				await signOut();
				throw new Error("Perfil não encontrado e não pôde ser criado. Contate o suporte.");
			}
			...
			if (!errorMessage.includes("Email ou senha")) toast({
...
//# sourceMappingURL=AdminLogin-DDZK9y27.js.map