...
import { M as require_react, N as __toESM, c as useAnalytics, h as createLucideIcon, o as useLanguage, r as Button, s as supabase, t as Skeleton, u as cn, w as require_jsx_runtime } from "./index-CBYPPi56.js";
...
const getBooks = async (language) => {
	...
	return await supabase.from("books").select("*").eq("language", searchLanguage).order("created_at", { ascending: false }).returns();
};
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				...
				children: [
					...
					book.curatorship && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookOpen, { className: "h-12 w-12 mx-auto mb-4 text-muted-foreground opacity-50" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "No books found for this language."
			})]
		})]
	});
}
...
//# sourceMappingURL=BooksPage-DMUbDxuW.js.map