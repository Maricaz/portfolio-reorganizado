...
import { D as Music, H as require_jsx_runtime, K as Link, M as createLucideIcon, Q as __toESM, Z as require_react, j as Code, m as Button, t as Skeleton, v as useLanguage } from "./index-Cd67lrX4.js";
...
import { r as getLatestItem } from "./database-SX4ETfgU.js";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "relative min-h-[50vh] flex flex-col justify-center items-center text-center space-y-8 max-w-4xl mx-auto py-12",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 -z-10 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 blur-3xl rounded-full opacity-50" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						className: "text-5xl md:text-8xl font-bold tracking-tight animate-fade-in-down bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "bg-muted/30 p-8 rounded-2xl border border-border/50 animate-fade-in delay-500 hover:bg-muted/50 transition-colors",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "w-full md:w-48 h-48 shrink-0 overflow-hidden rounded-xl shadow-md",
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-muted-foreground text-lg leading-relaxed line-clamp-2",
...
//# sourceMappingURL=Index-DM9NY9Jj.js.map