import { A as useNavigate, D as composeEventHandlers, E as useComposedRefs, N as require_react, P as __toESM, S as Primitive, T as require_jsx_runtime, b as useLayoutEffect2, c as useAnalytics, g as createLucideIcon, j as useParams, n as LanguageSwitchControlled, o as useLanguage, r as Button, s as supabase, t as Skeleton, u as cn, w as createContextScope, x as useCallbackRef, y as Presence } from "./index-C-k0zUEW.js";
import { n as CardContent, o as useSEO, t as Card } from "./card-CdZOsjwd.js";
import { t as Primitive$1 } from "./dist-CaqZhGMb.js";
import { t as useDirection } from "./dist-P7rS4zGx.js";
...
const getAlbumSettings = async () => {
	return await supabase.from("album_settings").select("*").limit(1).single();
};
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						platform === "native" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: track.audio_url ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("audio", {
								controls: true,
						...
						platform === "spotify" && track.spotify_track_id && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("iframe", {
						...
						platform === "deezer" && (track.deezer_track_id || track.deezer_id) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("iframe", {
						...
						platform === "apple" && track.apple_music_id && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("iframe", {
						...
						platform === "youtube" && track.youtube_video_id && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AspectRatio, {
							ratio: 16 / 9,
...
const SidePanel = ({ track, albumSettings, globalLanguage }) => {
	...
	const getLyrics = () => {
		if (!track) return "";
		if (track.lyrics && track.lyrics[lyricsLang]) return track.lyrics[lyricsLang];
		const specific = track.lyrics?.[lyricsLang];
		if (specific) return specific;
		return track.lyrics?.["pt"] || track.lyrics?.["en"] || "Lyrics not available for this language.";
	};
	const getAlbumDescription = () => {
		if (!albumSettings) return "";
		return albumSettings[`description_${globalLanguage}`] || albumSettings.description_en || "";
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				}) : albumSettings ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "space-y-6 animate-fade-in",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "text-2xl font-bold text-center",
							children: albumSettings.title
						}),
						albumSettings.cover_url && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						albumSettings.video_url && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function MusicPage() {
	...
	const [albumSettings, setAlbumSettings] = (0, import_react.useState)(null);
	...
	(0, import_react.useEffect)(() => {
		const fetchData = async () => {
			setLoading(true);
			const [tracksRes, albumRes] = await Promise.all([getMusicTracks(), getAlbumSettings()]);
			if (tracksRes.data) setTracks(tracksRes.data);
			if (albumRes.data) setAlbumSettings(albumRes.data);
			setLoading(false);
		};
		fetchData();
	}, []);
	(0, import_react.useEffect)(() => {
		if (tracks.length > 0 && trackId) {
			const found = tracks.find((t$1) => t$1.id === trackId);
			if (found) {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [tracks.map((track) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrackCard, {
						track,
...
//# sourceMappingURL=MusicPage-Dpdhqa7h.js.map