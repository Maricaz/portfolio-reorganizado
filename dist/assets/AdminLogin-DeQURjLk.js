import { t as Lock } from "./lock-COprgyZN.js";
import { Dt as Link, Et as useToast, K as ShieldAlert, Lt as __toESM, Pt as require_react, St as require_jsx_runtime, X as Mail, Z as LoaderCircle, jt as useNavigate, k as supabase, ot as createLucideIcon, v as Button, w as useAuth } from "./index-D09P2277.js";
import { a as CardHeader, n as CardContent, o as CardTitle, r as CardDescription, t as Card } from "./card-B9wIO7hV.js";
import { n as Input, t as Label } from "./label-BInDbCTU.js";
import { n as AlertDescription, r as AlertTitle, t as Alert } from "./alert-wQYvlS2S.js";
...
function AdminLogin() {
	...
	const handleLogin = async (e) => {
		...
		try {
			...
			let profile = null;
			const { data: profileData, error: profileError } = await supabase.from("profiles").select("role, is_banned").eq("id", data.user.id).single();
			if (profileError) if (profileError.code === "PGRST116") {
				...
				if (insertError) {
					...
					throw new Error("Perfil de usuário não encontrado e não pôde ser criado.");
				}
				profile = {
					role: "user",
					is_banned: false
...
//# sourceMappingURL=AdminLogin-DeQURjLk.js.map