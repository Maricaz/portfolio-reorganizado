import { s as supabase } from "./index-C4BVOJOy.js";
...
async function getLatestItem(language = "pt") {
	...
	const { data: book } = await supabase.from("books").select("*").eq("language", language).order("created_at", { ascending: false }).limit(1).single();
...
//# sourceMappingURL=database-Ds42zb8O.js.map