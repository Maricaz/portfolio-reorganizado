...
import { C as LanguageSwitchControlled, Ct as require_jsx_runtime, Et as composeEventHandlers, Ft as require_react, H as cn, J as Music, Mt as useNavigate, Nt as useParams, R as useSize, Rt as __toESM, St as createContextScope, T as useLanguage, Tt as useComposedRefs, _t as Primitive$1, dt as useControllableState, j as useAnalytics, r as Skeleton, st as createLucideIcon, v as Button, yt as createCollection } from "./index-DUov7ppI.js";
import { t as useSEO } from "./use-seo-LWbdJXYQ.js";
import { t as Primitive } from "./dist-BvFun2nb.js";
import { n as CardContent, t as Card } from "./card-D1iUmPli.js";
import { r as fetchMusic } from "./queries-C7wMNrqh.js";
import { n as AlertDescription, r as AlertTitle, t as Alert } from "./alert-Bo3SOp0P.js";
import { o as getAlbumConcept } from "./music-DWprIeqt.js";
import { t as clamp } from "./dist-Dfb5Wl6R.js";
import { t as useDirection } from "./dist-DsBJoYcX.js";
...
const TrackCard = ({ track, isActive, onPlay }) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
		className: cn("transition-all duration-300", isActive ? "border-l-4 border-l-primary shadow-[0_0_20px_rgba(147,51,234,0.3)] ring-1 ring-primary/20" : "border-l-4 border-l-transparent hover:border-l-muted-foreground/50"),
		id: `track-${track.id}`,
...
function MusicPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		const fetchData = async () => {
			setLoading(true);
			try {
				const [tracksData, albumData] = await Promise.all([fetchMusic().catch((err) => {
				...
				console.error("Unexpected error in MusicPage data fetch:", error$1);
...
//# sourceMappingURL=MusicPage-DVQPvWTQ.js.map