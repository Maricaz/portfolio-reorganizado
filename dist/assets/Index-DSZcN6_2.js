import { t as Calendar } from "./calendar-Bmb6UWz6.js";
import { t as CodeXml } from "./code-xml-BMmS0tNp.js";
import { A as useAnalytics, Et as Link, It as __toESM, K as Music, Nt as require_react, T as useLanguage, W as User, at as createLucideIcon, it as BookOpen, r as Skeleton, rt as Code, t as getSiteSettings, v as Button, xt as require_jsx_runtime } from "./index-BeLE7zEg.js";
import { t as useSEO } from "./use-seo-DF-I2S8a.js";
import { n as CardContent, t as Card } from "./card-Do66fycf.js";
import { t as getITProjects } from "./it-projects-BkTbWhoD.js";
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							className: "text-5xl md:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-purple-600 pb-2",
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-background shadow-2xl ring-4 ring-purple-500/20",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: cards.map((card, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
						className: "h-full hover:shadow-xl transition-all duration-300 border-purple-500/10 hover:border-purple-500/30 hover:-translate-y-1 bg-card/50 backdrop-blur-sm",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								className: "text-lg font-semibold group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors",
								children: card.title
							})]
						})
					})
...
//# sourceMappingURL=Index-DSZcN6_2.js.map