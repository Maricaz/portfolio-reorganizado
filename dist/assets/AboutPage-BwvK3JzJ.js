import { i as Award, n as MapPin, r as Briefcase, t as Progress } from "./progress-Dy_ATVkO.js";
import { t as Calendar } from "./calendar-DKNAxDef.js";
import { t as ChevronLeft } from "./chevron-left-DETxEPHl.js";
import { t as ChevronRight } from "./chevron-right-DcL0dGYv.js";
import { t as CodeXml } from "./code-xml-JcTu03f9.js";
import { t as ExternalLink } from "./external-link-CGYwHfab.js";
import { t as Globe } from "./globe-CtaLbeO0.js";
import { t as Image } from "./image-tc-_vZ_n.js";
import { A as useAnalytics, H as getLocalizedValue, Lt as __toESM, Pt as require_react, Q as Linkedin, St as require_jsx_runtime, T as useLanguage, U as Youtube, V as cn, X as Mail, k as supabase, nt as Github, ot as createLucideIcon, r as Skeleton, v as Button } from "./index-B7O7ZpYC.js";
import { a as getResumeExperience, r as getResumeCertifications } from "./resume-CuJTaRNF.js";
import { t as useSEO } from "./use-seo-DFyHNgaF.js";
import { n as CardContent, t as Card } from "./card-DJvQKytB.js";
import { t as Badge } from "./badge-BabG1TcY.js";
...
const getSocialLinks = async () => {
	const { data, error } = await supabase.from("social_links").select("*").order("order_index", { ascending: true }).order("created_at", { ascending: true });
	if (error) {
...
const getSkills = async () => {
	const { data, error } = await supabase.from("resume_skills").select("*").order("proficiency", { ascending: false });
	if (error) {
...
function ExperienceTimeline({ items, loading }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "relative space-y-8 pl-4 sm:pl-0",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute left-4 sm:left-[27px] top-2 bottom-2 w-0.5 bg-gradient-to-b from-cyan-500/50 to-purple-600/50 hidden sm:block" }), items.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "relative sm:pl-16 group",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute left-[19px] top-6 w-4 h-4 rounded-full bg-background border-2 border-cyan-500 shadow-[0_0_10px_rgba(6,182,212,0.5)] z-10 group-hover:scale-125 transition-transform duration-300 hidden sm:block" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
				className: "neon-card border-l-4 border-l-cyan-500 sm:border-l-transparent",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
					className: "p-6 space-y-4",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-col md:flex-row md:items-start justify-between gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-purple-600",
							children: getLocalizedValue(item, "role", language)
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "text-lg font-medium flex items-center gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Briefcase, { className: "h-4 w-4 text-muted-foreground" }), item.company]
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex flex-col items-start md:items-end gap-1 text-sm text-muted-foreground",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Badge, {
								...
								children: [
									...
									" -",
									" ",
									item.end_date ? formatDate(item.end_date) : t.resume.present
								]
							}), getLocalizedValue(item, "location", language) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "flex items-center gap-1 mt-1 text-xs",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "h-3 w-3" }), getLocalizedValue(item, "location", language)]
							})]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "text-muted-foreground text-sm leading-relaxed whitespace-pre-line",
						children: getLocalizedValue(item, "description", language)
					})]
				})
			})]
		}, item.id))]
...
function CertificationsGrid({ items, loading }) {
	const { language, t } = useLanguage();
	const formatDate = (dateString) => {
		if (!dateString) return "";
		const date = new Date(dateString);
	...
	if (loading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: [
			...
			2,
			3
		].map((i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, { className: "h-40 w-full rounded-xl" }, i))
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
		children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "p-2.5 rounded-lg bg-purple-500/10 text-purple-600 dark:text-purple-400 ring-1 ring-purple-500/20 group-hover:bg-purple-500/20 group-hover:ring-purple-500/40 transition-all",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "font-bold leading-tight group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-cyan-500 group-hover:to-purple-600 transition-all",
							children: item.name
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-auto pt-4 flex items-center gap-2 text-xs text-muted-foreground border-t border-dashed border-border",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar, { className: "h-3 w-3" }), formatDate(item.date)]
					})
				]
			})
		}, item.id))
...
function AboutPage() {
	...
	const getIcon = (platform) => {
		...
		if (p.includes("github")) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Github, { className: iconClass });
		if (p.includes("linkedin")) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Linkedin, { className: iconClass });
		if (p.includes("youtube")) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Youtube, { className: iconClass });
		if (p.includes("instagram")) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Instagram, { className: iconClass });
		if (p.includes("twitter") || p.includes(" x ")) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Twitter, { className: iconClass });
		if (p.includes("facebook")) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Facebook, { className: iconClass });
		if (p.includes("mail") || p.includes("email")) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mail, { className: iconClass });
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Globe, { className: iconClass });
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "container mx-auto px-4 py-12 md:py-16 max-w-5xl space-y-20",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "grid grid-cols-1 md:grid-cols-2 gap-12 items-center",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "space-y-8 animate-fade-in-down",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							className: "text-4xl md:text-5xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-purple-600",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [
									...
									2,
									3
								].map((i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, { className: "h-10 w-24" }, i))
							}) : socials.map((social) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								variant: "outline",
								asChild: true,
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: getIcon(social.platform)
									}), social.platform]
								})
							}, social.id))
						})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "p-2.5 bg-gradient-to-br from-cyan-500/10 to-purple-600/10 rounded-xl text-purple-600 dark:text-purple-400",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Briefcase, { className: "h-6 w-6" })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-purple-600",
						children: t.resume.experience
					})]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						className: "text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-purple-600",
						children: t.resume.certifications
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CertificationsGrid, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: skills.map((skill) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-medium group-hover:text-cyan-500 transition-colors",
								children: skill.name
...
//# sourceMappingURL=AboutPage-BwvK3JzJ.js.map