-- Migration to fix books table structure and seed data (Retry)
-- Dropping table to ensure clean state and correct schema
...
-- Seed Data (Orhan Pamuk, Itamar Vieira Junior, Marilia Arnaud)
